/*
 * Программа для вычисления математических функций с возможностью
 * анализа результатов (поиск min/max, дифференцирование и т.д.)
 * Автор: [Ваше имя]
 */
...
int main(void) {
    ...
    printf("Программу расчета значений функции\n");
    ...
    while (1) {
        ...
        /* Если еще не рассчитывали, предлагаем сделать расчет */
